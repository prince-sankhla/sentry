...
export default async function RootRoute({
  ...
  switch (parts[0]) {
    case "awards": return <AwardsPage {...(props as any)} />;
    case "buyers": return <BuyersPage {...(props as any)} />;
    case "cases": return <CasesPage />;
    case "companies":
      if (parts.length === 2) return <CompanyDetailPage params={Promise.resolve({ companyId: parts[1] })} searchParams={searchParams} />;
    ...
    case "map": return <MapPage {...(props as any)} />;
    case "monitoring": return <MonitoringPage />;
    case "profile": return <ProfilePage {...(props as any)} />;
    case "red-flags": return <RedFlagsPage />;
    case "reports": return <ReportsPage {...(props as any)} />;
    case "research": return <ResearchPage {...(props as any)} />;
    case "review":
      if (parts[1] === "inbox") return <ReviewInboxPage />;
      return <ReviewPage {...(props as any)} />;
    case "risk": return <RiskPage {...(props as any)} />;
    case "settings": return <SettingsPage />;
    case "tenders":
      if (parts.length === 2) return <TenderDetailPage params={Promise.resolve({ tenderId: parts[1] })} />;
      return <TendersPage {...(props as any)} />;
    case "timeline": return <TimelinePage {...(props as any)} />;
    case "verification": return <VerificationPage {...(props as any)} />;
    default: notFound();
  }
}
