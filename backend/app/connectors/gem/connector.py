...
from app.connectors.gem.mapper import SOURCE_LABEL, SOURCE_NAME, map_record
from app.connectors.registry import register_connector


@register_connector
class GeMSourceConnector(FileBackedSourceConnector):
    metadata = SourceConnectorMetadata(name=SOURCE_NAME, label=SOURCE_LABEL, raw_directory="gem")
