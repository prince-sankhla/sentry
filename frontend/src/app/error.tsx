  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#0B0F14] px-5 text-[#E6E8EB]">
      <div className="w-full max-w-md rounded-[6px] border border-[#2A3441] bg-[#121821] p-6 text-center">
        <h1 className="text-xl font-semibold">Unable to load tenders</h1>
        <p className="mt-2 text-sm leading-6 text-[#9AA4AF]">
          The backend API did not return a successful response.
        </p>
        <button
          className="mt-5 rounded-[4px] border border-[#C58B2A] bg-[#2A2115] px-4 py-2 text-sm font-semibold text-[#F3D59A] hover:bg-[#332719]"
          onClick={reset}
          type="button"
        >
          Retry
