  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#0B0F14] px-5 text-[#E6E8EB]">
      <div className="w-full max-w-md rounded-[6px] border border-[#2A3441] bg-[#121821] p-6 text-center">
        <h1 className="text-xl font-semibold">Unable to load tender</h1>
        <p className="mt-2 text-sm leading-6 text-[#9AA4AF]">
          The tender details could not be loaded from the backend API.
        </p>
        <div className="mt-5 flex justify-center gap-3">
          ...
          <Link className="rounded-[4px] border border-[#2A3441] px-4 py-2 text-sm font-semibold" href="/tenders">
            Tenders
          </Link>
        </div>
      </div>
