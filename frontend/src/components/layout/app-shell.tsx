  ...
  return (
    <div className="min-h-screen bg-bg text-text">
      ...
      <header className="fixed inset-x-0 top-0 z-40 flex h-16 items-center gap-3 border-b border-border bg-bg-2/80 px-4 backdrop-blur-xl">
        ...
        <Link href="/" className="group flex items-center gap-2.5 pl-1 pr-2" aria-label="SENTRY home">
        ...
        <div className="ml-auto flex items-center gap-2.5">
          ...
          <span className="hidden xl:block">
            <StatusChip label={currentRole.shortLabel} detail="Workspace" pulse />
          </span>
        ...
        <div className="flex h-full flex-col overflow-y-auto px-3 py-5">
          ...
          {!collapsed && (
            <div className="mt-5 rounded-2xl border border-border bg-surface/60 p-4 elevate">
              ...
              <p className="mt-2 text-[11.5px] leading-relaxed text-muted">{currentRole.description}</p>
              <Button
                href="/investigations"
                variant="primary"
                size="sm"
