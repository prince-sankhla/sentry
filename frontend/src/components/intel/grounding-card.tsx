 ...
 * every narrative claim cites verifiable evidence from official records.
 */
    ...
    >
      ...
      {grounded && (
        <div className="mt-3 flex items-center gap-1.5 rounded-lg border border-success/30 bg-success/[0.07] px-2.5 py-1.5 text-[11px] font-medium text-success">
          <CheckCircle2 className="h-3.5 w-3.5" /> Every narrative claim cites verifiable evidence from official records.
        </div>
      )}
    </motion.div>
  );
